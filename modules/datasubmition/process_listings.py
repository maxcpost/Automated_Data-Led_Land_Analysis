        ...
        if not new_listings.empty:
            ...
            if 'State' in new_listings.columns:
                ...
                for index, row in new_listings.iterrows():
                    ...
                    new_listings.at[index, 'StockNumber'] = generate_stock_number(master_df, state_code)
            else:
                # Use market code as the state code
                for index, row in new_listings.iterrows():
                    new_listings.at[index, 'StockNumber'] = generate_stock_number(master_df, market['code'])
